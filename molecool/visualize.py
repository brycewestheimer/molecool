...
A module for functions related to visualization.
"""
...
# "." before atom_data represents a relative import (i.e. an import from the same directory)
from .atom_data import atom_colors
# Could have also used molecool.atom_data instead
